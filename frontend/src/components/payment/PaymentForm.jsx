...
const PaymentForm = ({ clientId }) => {
  ...
  // Add the missing handleCancelEdit function
        ...
        {isContractLoading ? (
          ...
          {showConfirmDialog && (
            <div className="fixed inset-0 bg-dark-800 bg-opacity-75 flex items-center justify-center z-50 backdrop-blur-sm">
              <div className="bg-white rounded-lg p-5 max-w-md w-full shadow-lg border border-light-400">
                <h3 className="text-lg font-medium mb-3 text-dark-700">Unsaved Changes</h3>

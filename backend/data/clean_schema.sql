-- Clean schema file without null characters
-- SQLite creates sqlite_sequence automatically, we don't need to create it
...
-- Create clients table first since it's referenced by other tables
